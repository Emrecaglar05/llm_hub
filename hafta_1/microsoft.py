...
from transformers import AutoTokenizer, pipeline # Hugging Face Transformers kütüphanesinden gerekli sınıfları içe aktarır. 
...
gen = pipeline(
    ...
    torchd_type="auto",       # PyTorch veri tipi otomatik seçilir (ör: float16)
